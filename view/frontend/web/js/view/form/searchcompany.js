...
//            });
            ...
            this.isApiError.subscribe(function (newValue) {
                if(newValue===true){
                    //set warn
                    this.warn('Kon geen kvk-informatie krijgen, vul het adres handmatig in');
                }else{
                    this.warn(false);//
                }
            }, this);
        ...
        initObservable:function(){            
            this._super().observe(['visible','error','warn','isApiError'] );
        ...
        processStreet:function(street,houseNumber,houseNumberAddition){
            ...
            if(arrStreet.length > minLength){
                ...
                processedStreet[minLength-1] = arrStreet.slice(minLength-1, arrStreet.length).join(' ');
